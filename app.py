...
st.info("Enter your **Top 10** board games of 2024 in order of preference (1 = most favorite). We'll compare them against our dataset of nearly 150 board game reviewers 'Best of 2024' lists and show the ones that most closely match your tastes.")
